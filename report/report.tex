...
%The next figure shows the scalability of Mt-metis on Xeon Phi. Despite
%the large number of measurements taken, results shows spikes when
%running mt-metis with a certain number of partitions. We can see that
%mt-metis scales up to 28 threads, declining rapidly for more than 60
%threads. %FIXME: Falar do numero de threads entre 28 e 60
%This is mainly due to the clustering and refinement stages.
...
%We did not changed the mapping to run only on 60 cores, but it would be
%interesting to do it and perform measurements with the operating system
%noise minimized.
